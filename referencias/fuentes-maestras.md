# Fuentes maestras y criterio de actualización
...
- [GPT-3: Language Models are Few-Shot Learners](https://openai.com/index/language-models-are-few-shot-learners/)
...
- [LLaMA](https://ai.meta.com/research/publications/llama-open-and-efficient-foundation-language-models/)
...
- [IEA 2026: Key Questions on Energy and AI](https://www.iea.org/reports/key-questions-on-energy-and-ai)
...
- [Límites de la autocorrección sin feedback externo](https://arxiv.org/abs/2310.01798)
...
- [Corrección del relato del dron, Royal Aeronautical Society](https://www.aerosociety.com/news/highlights-from-the-raes-future-combat-air-space-capabilities-summit/)
- [Apollo: in-context scheming](https://www.apolloresearch.ai/science/frontier-models-are-capable-of-incontext-scheming)
...
- [AISI: unsanctioned agent behaviour](https://www.aisi.gov.uk/blog/incident-report-unsanctioned-agent-behaviour-during-cyber-testing)
- [Moltbook community analysis](https://arxiv.org/abs/2602.12634)

## Codex y OpenAI

Estas páginas son las únicas fuentes normativas del capítulo de producto y deben revisarse al actualizarlo:

- [Best practices de Codex](https://learn.chatgpt.com/guides/best-practices)
...
- [Reglamento de IA consolidado a 27 de julio de 2026, EUR-Lex](https://eur-lex.europa.eu/legal-content/ES/TXT/?uri=CELEX:02024R1689-20260727)
- [Portal oficial del AI Act, Comisión Europea](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai)
- [AI Omnibus en vigor](https://digital-strategy.ec.europa.eu/en/news/ai-omnibus-enters-force)
- [Transparencia del artículo 50](https://digital-strategy.ec.europa.eu/en/faqs/transparency-obligations-under-article-50-ai-act)
- [Obligaciones de modelos de propósito general](https://digital-strategy.ec.europa.eu/en/factpages/general-purpose-ai-obligations-under-ai-act)
- [Guía introductoria de AESIA](https://aesia.digital.gob.es/storage/media/01-guia-introductoria-al-reglamento-de-ia.pdf)
- [Proyecto español de Ley Orgánica de buen uso y gobernanza de la IA](https://www.congreso.es/es/proyectos-de-ley?_iniciativas_id=121%2F000096&_iniciativas_legislatura=XV&_iniciativas_mode=mostrarDetalle&p_p_id=iniciativas&p_p_lifecycle=0&p_p_mode=view&p_p_state=normal)
- [Reglamento General de Protección de Datos](https://eur-lex.europa.eu/eli/reg/2016/679/oj)
- [Opinión 28/2024 del EDPB sobre modelos de IA](https://www.edpb.europa.eu/documents/opinion-of-the-board-art-64/opinion-282024-on-certain-data-protection-aspects-related-to_en)
- [AEPD: adecuación de sistemas de IA al RGPD](https://www.aepd.es/guias/adecuacion-rgpd-ia.pdf)
- [Directiva de copyright en el mercado único digital](https://eur-lex.europa.eu/eli/dir/2019/790/oj)
- [Directiva de responsabilidad por productos defectuosos](https://eur-lex.europa.eu/eli/dir/2024/2853/oj)
- [Cyber Resilience Act](https://eur-lex.europa.eu/eli/reg/2024/2847/oj)
- [Convenio Marco del Consejo de Europa sobre IA](https://www.coe.int/en/web/artificial-intelligence/the-framework-convention-on-artificial-intelligence)
- [Principios de IA de la OCDE](https://www.oecd.org/en/topics/ai-principles.html)
- [Recomendación de UNESCO sobre ética de la IA](https://www.unesco.org/en/legal-affairs/recommendation-ethics-artificial-intelligence)
- [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework)

## Prompting, evaluación y workflows verificables

- [Prompting de ChatGPT y Codex](https://learn.chatgpt.com/docs/prompting)
- [Model guidance: prompts, tools y evals](https://developers.openai.com/api/docs/guides/latest-model)
...
2. Conserva el hecho histórico aunque cambie el producto.
3. Marca funciones retiradas; no reescribas el pasado como si nunca hubieran existido.
4. Para un incidente, enlaza postmortem primario y registra correcciones.
5. Para cifras, guarda fecha, denominador, condiciones y versión del benchmark.
6. Ejecuta el validador de enlaces internos descrito en la raíz o usa `rg` para comprobar rutas.
