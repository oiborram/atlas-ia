...
export const CATEGORY_META: Record<string, { label: string; shortLabel: string; index: number }> = {
  ...
  '11-casos-y-experimentos': { label: 'Casos y experimentos', shortLabel: 'Casos', index: 11 },
  '12-codex': { label: 'Uso de Codex', shortLabel: 'Codex', index: 12 },
  '13-prompting-loop-graph-engineering': { label: 'Prompting, loops y grafos', shortLabel: 'Prompting', index: 13 },
  '14-ampliacion-avanzada': { label: 'Ampliación avanzada', shortLabel: 'Avanzado', index: 14 },
  '15-legal': { label: 'Legal y gobernanza', shortLabel: 'Legal', index: 15 },
  '16-panorama-actual': { label: 'Panorama actual', shortLabel: 'Panorama', index: 16 },
