...
Esta lección explica el patrón independientemente de una librería. Para traducirlo a productos concretos, consulta la [comparativa de LangGraph, CrewAI, AutoGen, OpenClaw y otros orquestadores](../06-era-agent-tools/06-frameworks-de-agentes.md).
